...
export function DeveloperPanel() {
  ...
  const actions: { label: string; action: DeveloperAction }[] = [
    ...
    { label: "Start Interactive Mission", action: "startInteractiveMission" },
    { label: "Complete Active Mission", action: "completeMission" },
    { label: "Reset Active Mission", action: "resetMission" },
    { label: "Answer Current Question Correctly", action: "correctAnswer" },
    { label: "Answer Current Question Incorrectly", action: "wrongAnswer" },
    { label: "Complete Speaking Timer", action: "completeSpeakingTimer" },
